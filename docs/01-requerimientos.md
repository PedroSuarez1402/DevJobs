...
### 1.3. Modo Empleador
- **RF-010:** El sistema debe permitir a un usuario (en modo empleador) crear una nueva vacante de empleo, especificando título, descripción, salario, tipo de contrato, etc.
- **RF-011:** El sistema debe permitir al empleador editar las vacantes que ha creado.
- **RF-012:** El sistema debe permitir al empleador eliminar las vacantes que ha creado.
- **RF-013:** El sistema debe permitir al empleador ver la lista de candidatos que se han postulado a sus vacantes.
- **RF-014:** El sistema debe permitir al empleador aceptar o rechazar a un postulante.

### 1.4. Modo Candidato
- **RF-015:** El sistema debe permitir a un usuario (en modo candidato) buscar vacantes por palabra clave, tecnología o ubicación.
- **RF-016:** El sistema debe permitir al candidato ver los detalles de una vacante.
- **RF-017:** El sistema debe permitir al candidato postularse a una vacante.
- **RF-018:** El sistema debe impedir que un usuario se postule a una vacante creada por él mismo.

### 1.5. Funciones Sociales
- **RF-019:** El sistema debe permitir a los usuarios crear posts de texto.
- **RF-020:** El sistema debe permitir a los usuarios crear canales temáticos (ej. "Desarrollo Frontend", "Python Avanzado").
- **RF-021:** El sistema debe permitir a los usuarios unirse a canales existentes.
- **RF-022:** El sistema debe permitir a un usuario seguir a otro usuario.
- **RF-023:** El sistema debe permitir a un usuario ver la lista de sus seguidores y a quiénes sigue.
